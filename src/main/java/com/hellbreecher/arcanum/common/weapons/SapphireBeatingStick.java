...
public class SapphireBeatingStick extends SwordItem {

    public SapphireBeatingStick() {
        super(EnumToolMaterial.SapphireBeatingStick, 1, 0F, new Properties().group(Arcanum.arcanum).maxDamage(-1));
