package com.hellbreecher.arcanum.client.particles;
...
public class GreenFlameParticle extends SpriteTexturedParticle{
	   ...
	   private GreenFlameParticle(ClientWorld p_i232392_1_, double p_i232392_2_, double p_i232392_4_, double p_i232392_6_, double p_i232392_8_, double p_i232392_10_, double p_i232392_12_) {
